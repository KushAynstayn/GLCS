                ...
                <tbody id="userTableBody" class="divide-y divide-gray-100 bg-white uppercase">
                    <?php if (!empty($users)): ?>
                        <?php foreach ($users as $index => $user): ?>
                            <tr data-id="<?= $user['id'] ?>"
                                class=" user-row group relative row-fluid-transition cursor-pointer border-b border-gray-100 bg-white hover:bg-red-100/60">
...
<script src="../resources/assets/js/user_management.js"></script>
